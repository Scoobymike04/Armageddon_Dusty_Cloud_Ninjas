...
resource "aws_launch_template" "launch_tokyo" {
  provider      = aws.Tokyo
  name          = "launch_tokyo"
  ...
  user_data = base64encode(<<-EOF
    ...
    <head>
    <title>Details Tokyo EC2 instances</title>
    </head>
    <body>
    <div>
    <h1>Tokyo/h1>
...
resource "aws_launch_template" "launch_new-york" {
...
resource "aws_launch_template" "launch_london" {
  provider      = aws.London
  name          = "launch_london"
  ...
  user_data = base64encode(<<-EOF
    ...
    <html lang="en" class="h-100">
    <head>
    <title>Details London EC2 instances</title>
    </head>
    <body>
    <div>
    <h1>London/h1>
...
resource "aws_launch_template" "launch_sao-paulo" {
  ...
  user_data = base64encode(<<-EOF
    ...
    <html lang="en" class="h-100">
    <head>
    <title>Details Sao Paulo EC2 instances</title>
    </head>
    <body>
    <div>
    <h1>Sao Paulo/h1>
...
resource "aws_launch_template" "launch_australia" {
  ...
  user_data = base64encode(<<-EOF
    ...
    <html lang="en" class="h-100">
    <head>
    <title>Details Australia EC2 instances</title>
    </head>
    <body>
    <div>
    <h1>Australia/h1>
...
resource "aws_launch_template" "launch_hong-kong" {
  ...
  user_data = base64encode(<<-EOF
    ...
    <html lang="en" class="h-100">
    <head>
    <title>Details Hong Kong EC2 instances</title>
    </head>
    <body>
    <div>
    <h1>Malgus Clan</h1>
...
resource "aws_launch_template" "launch_california" {
  ...
  user_data = base64encode(<<-EOF
    ...
    <html lang="en" class="h-100">
    <head>
    <title>Details California EC2 instances</title>
    </head>
    <body>
    <div>
    <h1>California/h1>
